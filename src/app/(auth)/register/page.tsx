      ...
      <div className="w-full max-w-sm">
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-xs">アカウントを作成してください</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              <div className="space-y-1.5">
                ...
                <Input {...register("name")} className="h-9 text-sm" placeholder="山田 太郎" />
              ...
              <div className="space-y-1.5">
                <Label className="text-xs">パスワード（確認）</Label>
                <Input {...register("confirmPassword")} type="password" className="h-9 text-sm" />
